...
/**
 * @title interchange/dex/buy_order_book.proto
...
export class Api<SecurityDataType extends unknown> extends HttpClient<SecurityDataType> {
   ...
   * @request GET:/interchange/dex/buy_order_book
   */
  queryBuyOrderBookAll = (
    ...
    this.request<DexQueryAllBuyOrderBookResponse, RpcStatus>({
      path: `/interchange/dex/buy_order_book`,
      method: "GET",
      query: query,
      format: "json",
      ...params,
   ...
   * @request GET:/interchange/dex/buy_order_book/{index}
   */
   ...
   * @request GET:/interchange/dex/params
   */
  queryParams = (params: RequestParams = {}) =>
    this.request<DexQueryParamsResponse, RpcStatus>({
      path: `/interchange/dex/params`,
      method: "GET",
      format: "json",
      ...params,
    });
   ...
   * @request GET:/interchange/dex/sell_order_book
   */
  querySellOrderBookAll = (
    ...
    this.request<DexQueryAllSellOrderBookResponse, RpcStatus>({
      path: `/interchange/dex/sell_order_book`,
      method: "GET",
      query: query,
      format: "json",
      ...params,
